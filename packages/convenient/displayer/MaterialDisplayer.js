import { AmbientLight, BoxGeometry, Line, Mesh, MeshStandardMaterial, Object3D, PCFSoftShadowMap, PerspectiveCamera, PointLight, Points, Scene, SphereGeometry, Sprite, Vector3, WebGLRenderer, } from "three";
const pointLight = new PointLight("rgb(255, 255, 255)", 0.5, 200, 1);
pointLight.position.set(-30, 5, 20);
pointLight.castShadow = true;
const plane = new Mesh(new BoxGeometry(80, 2, 80), new MeshStandardMaterial({
...
export class MaterialDisplayer {
    static { this.ambientLight = new AmbientLight("rgb(255, 255, 255)", 0.7); }
    static { this.pointLight = pointLight; }
    static { this.geometry = new SphereGeometry(10, 12, 12); }
    static { this.plane = plane; }
    static { this.dispose = () => {
